...
public final class BoxedMessage {
	 ...
	 * @param messages
	 */
	private BoxedMessage(Iterable<? extends CommandSender> recipients, ProxiedPlayer sender, @NonNull String[] messages) {
	 ...
	 * @param sender
	 */
	public void broadcastAs(ProxiedPlayer sender) {
	 ...
	 * @param sender
	 */
	public void tellAs(CommandSender receiver, ProxiedPlayer sender) {
	 ...
	 * @param sender
	 */
	public void tellAs(Iterable<? extends CommandSender> receivers, ProxiedPlayer sender) {
	 ...
	 * @param messages
	 */
	public static void broadcast(ProxiedPlayer sender, String... messages) {
		new BoxedMessage(null, sender, messages).launch();
	}
	 ...
	 * @param messages
	 */
	public static void tell(ProxiedPlayer sender, CommandSender receiver, String... messages) {
		tell(sender, Arrays.asList(receiver), messages);
	}
	 ...
	 * @param messages
	 */
	public static void tell(ProxiedPlayer sender, Iterable<? extends CommandSender> receivers, String... messages) {
		new BoxedMessage(receivers, sender, messages).launch();
	}
